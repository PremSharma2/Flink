 ...
 */
package part2datastreams.KeyedStream
...
object KeyedTransformations {
  ...
  def main(args: Array[String]) {
    ...
    val readings: DataStream[SensorReading] = env
      ...
      // assign timestamps and watermarks which are required for event time T-5seconds
    ...
    val maxTempPerSensor: DataStream[SensorReading] =
      keyed
      .reduce((r1, r2) => {
