...
object ScalaAPIStreamTransformations {
  ...
  def main(args: Array[String]) {
    ...
    env.getConfig.setAutoWatermarkInterval(1000L) // 1 sec i.e T-1sec
    ...
    val readings: DataStream[SensorReading] =
      ...
      // assign timestamps and watermarks which are required for event time i.e T-5seconds
   ...
   //   .filter(new TemperatureFilter(25))
    ...
    val splitIds: DataStream[String] =
      sensorIds
